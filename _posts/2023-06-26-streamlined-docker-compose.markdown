...
It should be noted that I have intentionally removed postfix from the docker-compose.yml as I believe that it's a bad idea for people to run postfix on home servers and/or VPS's without knowing what they are doing. You will almost certainly have most/all of your outgoing mail rejected by recipient servers. I recommend using one of the many mail services such as sendgrid, mailgun, postmark, etc. If you feel differently, feel free to do it your way.
